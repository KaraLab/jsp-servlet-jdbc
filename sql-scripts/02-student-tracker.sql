...
INSERT INTO `student` VALUES (1,'Mary','Public','mary@luv2code.org'),(2,'John','Doe','john@luv2code.org'),(3,'Ajay','Rao','ajay@luv2code.org'),(4,'Bill','Neely','bill@luv2code.org'),(5,'Maxwell','Dixon','max@luv2code.org');
